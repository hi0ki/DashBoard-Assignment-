...
// 🔑 FIX: Import useAuth for reliable token access
...
function Dashboard() {
    ...
    // 🔑 FIX: Retrieve the reliable getToken function
        ...
        "Dashboard.useEffect": ()=>{
            const loadDashboardData = {
                "Dashboard.useEffect.loadDashboardData": async ()=>{
                    // Only proceed if the user ID is available
                    if (!clerkUser?.id) {
                        setLoading(false); // Stop loading if user isn't logged in
                        return;
                    }
                    ;
                    try {
                        // 🔑 FIX: Use the reliable getToken() from useAuth
                        ...
                        if (!response.ok) {
                            ...
                            // Line 75 in your original file: logs the error
                            console.error('Dashboard stats response error:', response.status, text);
                            // Line 76 in your original file: throws the error
            ...
            loadDashboardData();
        // 🔑 FIX: Added getToken to the dependency array
        }
    }["Dashboard.useEffect"], [
        clerkUser?.id,
        getToken
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            errorMsg && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "p-3 rounded-md bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-sm text-red-700",
                children: [
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    style: {
                                        width: stats ? `${Math.min(100, stats.usage.count / stats.usage.total * 100)}%` : '0%'
                                    },
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: !stats ? 'Loading...' : stats.usage.count >= stats.usage.total ? "You have reached your daily limit. Please come back tomorrow." : `You can view details for ${stats.usage.remaining} more contacts today.`
                            }, void 0, false, {
                                fileName: "[project]/app/(dashboard)/dashboard/page.tsx",
                                lineNumber: 177,
                                columnNumber: 15
...
_s(Dashboard, "JsUbUJpTQ7s0uSOF3DBA6XywNlU=", false, function() {
    return [
...
//# sourceMappingURL=_ee69cfbb._.js.map