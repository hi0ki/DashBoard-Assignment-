...
function Dashboard() {
    ...
    const [jobTitleStats, setJobTitleStats] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
            ...
            const loadDashboardData = {
                "Dashboard.useEffect.loadDashboardData": async ()=>{
                    try {
                        ...
                        setStats(data);
                        // Fetch ALL contacts to calculate job title distribution
                        const contactsResponse = await fetch('/api/contacts?limit=1000');
                        if (contactsResponse.ok) {
                            const contactsData = await contactsResponse.json();
                            const allContacts = contactsData.contacts || [];
                            // Set recent contacts (first 5)
                            setRecentContacts(allContacts.slice(0, 5));
                            // Calculate job title statistics
                            const jobTitleMap = new Map();
                            allContacts.forEach({
                                "Dashboard.useEffect.loadDashboardData": (contact)=>{
                                    if (contact.jobTitle) {
                            ...
                            const totalWithJobTitles = Array.from(jobTitleMap.values()).reduce({
                                "Dashboard.useEffect.loadDashboardData.totalWithJobTitles": (a, b)=>a + b
                            }["Dashboard.useEffect.loadDashboardData.totalWithJobTitles"], 0);
                            const jobTitleArray = Array.from(jobTitleMap.entries()).map({
                                "Dashboard.useEffect.loadDashboardData.jobTitleArray": ([title, count], index)=>({
                                        title,
                                        count,
                                        percentage: Math.round(count / totalWithJobTitles * 100),
                                        color: colors[index % colors.length]
                                    })
                            }["Dashboard.useEffect.loadDashboardData.jobTitleArray"]).sort({
                                "Dashboard.useEffect.loadDashboardData.jobTitleArray": (a, b)=>b.count - a.count
                            }["Dashboard.useEffect.loadDashboardData.jobTitleArray"]).slice(0, 5);
                            setJobTitleStats(jobTitleArray);
                        }
                    } catch (error) {
    ...
    const totalPercentage = jobTitleStats.reduce((sum, stat)=>sum + stat.percentage, 0);
    let currentAngle = 0;
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "p-2.5 rounded-lg bg-purple-600",
                            ...
                            loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                lineNumber: 327,
                                columnNumber: 13
                            }, this) : jobTitleStats.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "space-y-6",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                                                ...
                                                children: [
                                                    ...
                                                    jobTitleStats.map((stat, index)=>{
                                                        const segmentAngle = stat.percentage / 100 * 360;
                                                        const circumference = 2 * Math.PI * 35;
                                                        const dashArray = `${segmentAngle / 360 * circumference} ${circumference}`;
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        ...
                                                        children: jobTitleStats.reduce((sum, stat)=>sum + stat.count, 0)
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/(dashboard)/dashboard/page.tsx",
                                                        lineNumber: 373,
                                                        columnNumber: 19
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "space-y-2",
                                        children: jobTitleStats.map((stat)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Dashboard, "UvnfOtbmU718EbDMzmOR3UYy6rw=", false, function() {
    return [
...
//# sourceMappingURL=_7e707c99._.js.map