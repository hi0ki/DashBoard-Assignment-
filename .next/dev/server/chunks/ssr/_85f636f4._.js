...
function Login() {
    ...
    const { signIn, setActive } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$clerk$2d$react$2f$dist$2f$chunk$2d$F54Q6IK5$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useSignIn"])();
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (errorCode === 'form_identifier_not_found' || errorMessage.toLowerCase().includes('identifier') || errorMessage.toLowerCase().includes('not found') || errorMessage.toLowerCase().includes('invalid')) {
                setError(/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    children: [
...
//# sourceMappingURL=_85f636f4._.js.map