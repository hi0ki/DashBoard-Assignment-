...
function Contacts() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        // Load contacts
        __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$dataService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dataService"].getContacts().then((data)=>{
            setContacts(data);
            setLoading(false);
        });
        // Load persisted unlocked status and limit
        const unlocked = __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$dataService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dataService"].getUnlockedContactIds();
        setViewedIds(unlocked);
        const stats = __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$dataService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dataService"].getUsageStats();
        setRemaining(stats.total - stats.count);
    }, []);
    const handleViewContact = async (id)=>{
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$dataService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dataService"].unlockContact(id);
        if (result.success) {
