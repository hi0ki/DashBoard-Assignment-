...
async function GET(request) {
    try {
        ...
        const userProfile = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].userProfile.findUnique({
            where: {
                clerkUserId: userId
            }
        });
        ...
        if (userProfile) {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].userProfile.create({
                data: {
                    clerkUserId: userId,
...
async function POST(request) {
    try {
        ...
        const contact = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].contact.create({
            data: {
                name,
                email,
                phone,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5fd488f2._.js.map